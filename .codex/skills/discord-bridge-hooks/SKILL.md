...
description: Schedule, list, or cancel one-time Discord reminder hooks when Codex is running inside discord-bridge. Use when the user asks to be reminded later, says to schedule a message, or asks about bridge hooks/reminders.
---
